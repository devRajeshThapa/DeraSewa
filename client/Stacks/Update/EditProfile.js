            ...
            <View style={styles.contentWrapper}>
                ...
                <View style={styles.nameInputFeild}>
                    <View>
                        ...
                        <TextInput style={styles.nameInput} placeholder="First Name" placeholderTextColor="white" value={`${firstName}`} onChangeText={(value) => { setFirstName(value); setError(""); setSuccess(""); setDoneChanges(true); }} autoCorrect={false} />
                    </View>
                    <View>
                        <Text style={styles.title}>Last Name</Text>
                        <TextInput style={styles.nameInput} placeholder="Last Name" placeholderTextColor="white" value={`${lastName}`} onChangeText={(value) => { setLastName(value); setError(""); setSuccess(""); setDoneChanges(true); }} autoCorrect={false} />
                    </View>
                </View>
                <View>
                    <Text style={styles.title}>Email</Text>
                    <TextInput style={styles.input} placeholder="Email" placeholderTextColor="white" value={`${email}`} onChangeText={(value) => { setEmail(value); setError(""); setSuccess(""); setDoneChanges(true); }} autoCorrect={false} />
                </View>
                <View>
                ...
                <View style={{ position: "relative", display: "flex", justifyContent: "center"}}>
                    ...
                    {
                        passHidden ?
                            <TextInput style={styles.input} placeholder='Password' value={password} placeholderTextColor="white" secureTextEntry onChangeText={(value) => { setPassword(value); setError(""); setSuccess(""); setDoneChanges(true); }} autoCorrect={false} />
                            :
                            <TextInput style={styles.input} placeholder='Password' value={password} placeholderTextColor="white" onChangeText={(value) => { setPassword(value); setError(""); setSuccess(""); setDoneChanges(true); }} autoCorrect={false} />
                    }
                </View>
                {
                    doneChanges ?
